...
**Outcome:** All 13 skills have matching commands in `.claude/commands/`. Commands load the skill into context and apply it. Parity rule is enforced in both directions and documented in `CLAUDE.md` and `copilot-instructions.md`.
